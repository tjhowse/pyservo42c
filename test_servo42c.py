...
class TestServo42C(unittest.TestCase):
    ...
    def test_set_constant_speed_cmd(self):
        ...
        result = self.servo.set_constant_speed_cmd(Servo42C.Direction.CLOCKWISE, 1)
        self.assertEqual(result, bytes([0xE0, 0xF6, 0x01, 0xD7]))

        # Example: set_constant_speed_cmd(1, 1) -> [e0 f6 81 57]
        result = self.servo.set_constant_speed_cmd(Servo42C.Direction.COUNTERCLOCKWISE, 1)
    ...
    def test_set_work_mode_cmd(self):
        ...
        result = self.servo.set_work_mode_cmd(Servo42C.WorkMode.CR_VFOC)
    ...
    def test_set_current_gear_cmd(self):
        ...
        result = self.servo.set_current_gear_cmd(Servo42C.CurrentGear.MA_1200)
    ...
    def test_set_pid_ki_cmd(self):
        ...
        result = self.servo.set_pid_ki_cmd(0x02)
    ...
    def test_set_pid_kd_cmd(self):
        ...
        result = self.servo.set_pid_kd_cmd(0x250)
    ...
    def test_set_acceleration_cmd(self):
        ...
        result = self.servo.set_acceleration_cmd(0x80)
    ...
    def test_set_max_torque_cmd(self):
        ...
        result = self.servo.set_max_torque_cmd(0x258)
